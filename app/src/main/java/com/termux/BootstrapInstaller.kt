...
""")
            ...
            // Create install-godot script (Godot Engine CLI installer)
...
""")
            installGodotScript.setExecutable(true)
            Log.i(TAG, "Created install-godot script")

            // Create selfmod script (Self-Modification Wizard)
            val selfmodScript = File(binDir, "selfmod")
            selfmodScript.writeText("""#!/data/data/com.termux/files/usr/bin/bash
...
main
""")
            selfmodScript.setExecutable(true)
            Log.i(TAG, "Created selfmod script")

            // Create extract-source script (Source Extraction)
            val extractSourceScript = File(binDir, "extract-source")
            extractSourceScript.writeText("""#!/data/data/com.termux/files/usr/bin/bash
...
""")
            extractSourceScript.setExecutable(true)
            Log.i(TAG, "Created extract-source script")
